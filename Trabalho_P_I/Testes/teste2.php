...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Tratamento de erro para qualquer exceção lançada durante o processamento do formulário
...
<body>
    ...
    <div class="container mt-4" id="cadastro">
        ...
        <div class="mt-4">
            ...
            <table id="tabela-carros-cadastrados" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>N° Carro</th>
                        <th>Equipe</th>
    ...
    <div class="container mt-4" id="prova1" style="display: none;">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group">
                ...
                <select class="form-control" aria-label="Default select example" id="carro_id" name="carro_id">
                    ...
                    <?php
                    // Recupera os carros cadastrados
        ...
        <div class="mt-4">
            ...
            <table id="tabela-resultados-prova1" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>N° Carro</th>
                        <!-- <th>Equipe</th> -->
    ...
    <div class="container mt-4" id="prova2" style="display: none;">
        ...
        <div class="mt-4">
            ...
            <table id="tabela-resultados-prova2" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>N° Carro</th>
                        <th>Tempo(seg)</th>
                ...
                <tbody>
                    ...
                    $stmt = $conn->query("SELECT prova_2.id, prova_2.carro_id, prova_2.tempo, prova_2.penalidade, prova_2.tempo_ajustado, prova_2.colocacao, prova_2.pontuacao, carros.numero
                                        FROM prova_2
    ...
    <div class="container mt-4" id="prova3" style="display: none;">
        ...
        <table id="tabela-resultados-prova3" class="table table-striped table-bordered">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                $stmt = $conn->prepare('SELECT p3.*, c.numero FROM prova_3 p3 JOIN carros c ON p3.carro_id = c.id ORDER BY p3.peso_retentor DESC');
                $stmt->execute();
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#tabela-carros-cadastrados').DataTable({
                ...
                "language": {
                    ...
                    "search": "Pesquisar N° Carro:", // Texto personalizado para a barra de pesquisa
                    "paginate": {
                        "first": "Primeira",
                        "last": "Última",
                        "next": "Próxima",
        ...
        $(document).ready(function () {
            $('#tabela-resultados-prova3').DataTable({
                // Configurações do DataTable
                "order": [[2, "asc"]], // Ordena pela 3ª coluna (colocação) em ordem ascendente
                "language": {
                    "lengthMenu": "Mostrar _MENU_ resultados", // Texto personalizado para mostrar a quantidade de resultados
                    "info": "Mostrando _START_ a _END_ de _TOTAL_ resultados", // Texto personalizado para mostrar informações sobre a exibição de resultados
                    "search": "Pesquisar N° Carro:", // Texto personalizado para a barra de pesquisa
