...
<head>
    ...
    <style>
        .container {
            max-width: 1000px; /* Aumentar largura do container */
        }
    </style>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="mostrarCadastro('resultados')">Resultados Finais</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container mt-4" id="prova3" style="display: none;">
        ...
        <table id="tabela-resultados-prova3" class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                $stmt = $conn->prepare('SELECT p3.*, c.numero, c.equipe FROM prova_3 p3 JOIN carros c ON p3.carro_id = c.id ORDER BY p3.peso_retentor DESC');
                $stmt->execute();
