...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $carroId = filter_input(INPUT_POST, 'editCarroIdProva1', FILTER_VALIDATE_INT);
    $distanciaPercorrida = filter_input(INPUT_POST, 'editDistanciaPercorridaProva1', FILTER_VALIDATE_FLOAT);
    $naoParticipou = isset($_POST['editNaoParticipouProva1']) ? 1 : 0;
